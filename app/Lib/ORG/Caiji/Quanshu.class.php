 ...
 * @Date   2015/08/14
 * @Author ZhangYe
 * @@  quanshu.net 小说内容采集接口
 *
***/
if( !defined('ORG_CAIJI') )
	require_once('_Caiji.php');

class  Quanshu extends _Caiji
{
	...
	{
		$this->m_baseURL   = $_baseURL ? $_baseURL : 'http://www.quanshu.net/';
	...
	//示例URL http://www.quanshu.net/modules/article/index.php?page=1
